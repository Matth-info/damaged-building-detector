...
color_dict = {
    ...
    1: (255, 0, 0),     # Red - Major Damage
    2: (255, 165, 0),   # Orange - Moderate Damage
    3: (255, 255, 0),   # Yellow - Minor Damage
    4: (0, 255, 0)      # Green - No Damage but affected
}
...
def predict(x1, x2):
    ...
    # Apply color mapping
    colorized_pred = apply_color_map(predictions, color_dict)  # Shape: (1, 3, H, W)
...
transform = get_augmentation_pipeline(image_size=(256,256))
...
demo = gr.Interface(
    ...
    examples=[
        ["../data/data_samples/Levir-cd/test/A/test_101.png", "../data/data_samples/Levir-cd/test/B/test_101.png"],
        ["../data/data_samples/xDB/tier3/images/joplin-tornado_00000000_pre_disaster.png", "../data/data_samples/xDB/tier3/images/joplin-tornado_00000000_post_disaster.png"]
    ]
)
