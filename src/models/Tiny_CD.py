""" 
Official implementation of Tiny CD a Change Detection model 
Source : https://github.com/AndreaCodegoni/Tiny_model_4_CD/
"""
...
class TinyCD(Module):
    def __init__(
        ...
        self._classify = PixelwiseLinear([32, 16, 8], [16, 8, out_channels], Sigmoid())
