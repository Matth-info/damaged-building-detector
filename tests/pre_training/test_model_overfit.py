...
@pytest.mark.parametrize("model_class, kwargs", [
   (SiameseResNetUNet, {"in_channels": 3, "out_channels": 2, "backbone_name": "resnet18", "pretrained": False, "mode": "conc"}),
   (TinyCD, {"bkbn_name": "efficientnet_b4", "pretrained": False, "output_layer_bkbn": "3", "out_channels": 2, "freeze_backbone": False}),
   (BiT, {"input_nc": 3, "output_nc": 2, "with_pos": "learned", "resnet_stages_num": 4, "backbone": "resnet18"})
])
